...
\section{}
	...
	Proof:
		...
		\begin{equation*}
			\begin{split}
				% \mathbb{E}(U^2) &= \mathbb{E} \left[\left(\frac{n}{\theta} - \sum_{i=1}^n y_i\right)^2\right]\\
				% &= \mathbb{E} \left[\frac{n^2}{\theta^2} - \frac{2n\sum_{i=1}^n y_i}{\theta} + \left(\sum_{i=1}^n y_i\right)^2\right]\\
				% &= \frac{n^2}{\theta^2} - \frac{2n^2}{\theta^2} + Var
